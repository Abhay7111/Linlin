...
function Table_page() {
     var data = [
          ...
          {id:'1',specification:'Insulation',value:'Duble-Wall Vacuum'},
          {id:'1',specification:'Tumperature Retention',value:'Hot: 12h, Cold: 24h'},
          {id:'1',specification:'Lid Type',value:'Leak-Proof, BPA-Free'},
          {id:'1',specification:'Waight',value:'320g'},
          ...
          <div className='w-[80vw] h-fit flex flex-col'>
               ...
               <div className='w-full flex flex-col items-start'>
                   {data.map((items, index)=> (
                    <div className='w-full h-fit p-5 bg-transparent flex items-start border-b border-zinc-300'>
